...
from urllib3.connection import HTTPConnection  # type: ignore[import]
...
class Http:
    def __init__(
        ...
        *,
        ...
        timeout_protocol: Optional[TimeoutT] = None,
    ) -> None:
    ...
    def _command(
        ...
        timeout_cmd: Optional[TimeoutT] = None,
        stream: bool = False,
    ) -> requests.Response:
