...
class Ptz(Http):
    ...
    def ptz_presets_count(self, channel: int = 0) -> int:
    ...
    def go_to_preset(
        self, action, channel: int = 0, preset_point_number: int = 1
    ) -> str:
        """
        Params:
            action              - start or stop
    ...
    def tour(
        self, channel: int = 0, start: bool = True, tour_path_number: int = 1
    ) -> str:
        """
        Params:
            action              - start or stop
